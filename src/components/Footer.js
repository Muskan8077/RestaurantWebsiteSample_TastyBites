      ...
      <div className="container mx-auto px-4 py-10">
        <div className="flex flex-col gap-8 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-8">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <div className="flex items-center space-x-2 mb-4 justify-center md:justify-start w-full">
              ...
              <h3 className="text-2xl font-bold font-serif">TastyBites</h3>
            </div>
            <p className="text-gray-300 mb-6">
              ...
              <br/><i>Note: A sample website created by Muskaan Malik</i>
            </p>
            <div className="flex space-x-4 justify-center md:justify-start w-full">
              <a href="#" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-white hover:bg-primary-600 transition-colors duration-200">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-center md:justify-start space-x-3">
                ...
                <p className="text-gray-300 text-sm">051 12345</p>
              </div>
              <div className="flex items-center justify-center md:justify-start space-x-3">
                <svg className="w-5 h-5 text-primary-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <p className="text-gray-300 text-sm">info@tastybites.com</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-2">
            <p className="text-gray-400 text-sm">
              &copy; {currentYear} TastyBites. All rights reserved.
            </p>
